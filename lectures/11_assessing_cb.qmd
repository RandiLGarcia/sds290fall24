...
-   SDS Presentation of the Major on Tuesday
-   HW 5 due Friday 10/18 11:59p
-   Exam 1 [self-scheduled](https://www.science.smith.edu/self-scheduled-exams/) 10/25-10/27
...
-   Where to get HW help
    ...
    -   Post questions to [hw5-questions](https://smith.enterprise.slack.com/archives/C07RQ22U2LX) Slack channel.
...
-   If you're approved:
    -   20 minutes to go through the [checklist](https://randilgarcia.github.io/sds290fall24/lectures/10_complete_block.html#/next-steps).
    -   Paste anonymous survey link in the [spreadsheet](https://docs.google.com/spreadsheets/d/1450Zh34eISDn-nLjccItp4oD7uWKYzDIJUcVU9uVSFw/edit?gid=0#gid=0).
...
-   25 min to participate in as many studies as you can!
    -   Note: see content notes
